...
export const siteConfig = {
	...
	cta: {
		partnerForm: "https://airtable.com/appqqzliZuiI7PfV9/pagndaAdD7dCgazFF/form",
		expertRegister: "https://app.rothr.com/candidate/register",
	},
	utm: {
		source: `${SITE_URL}`,
		medium: "referral",
	...
	meta: {
		...
		keywords:
			"design intelligence, AI preference data, UI evaluation, red teaming, reinforcement learning, human feedback, RLHF, UX evaluation",
...
export const socialLinks = [
	...
	{
		name: "Github",
		url: "https://github.com/ricocc/ricoui-saas-template",
